...
import axiosInstance from '../utils/axios'; // CHANGED: axios instance import
...
function Login() {
    ...
    const handleLogin = async (e) => {
        e.preventDefault(); // CHANGED: Moved to top
        setLoading(true);

        try {
            // CHANGED: Using axiosInstance and cleaner structure
